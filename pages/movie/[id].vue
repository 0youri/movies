<template>
  <div class="p-4 bg-gray-900 min-h-screen">
    ...
    <NuxtLink to="/" class="flex items-center justify-center p-2 mt-2 bg-gray-700 text-white rounded-lg hover:bg-gray-600">
    ...
    <div v-if="movie" class="py-6 px-8 bg-gray-900 text-white min-h-screen">
